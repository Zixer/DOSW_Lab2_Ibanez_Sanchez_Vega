...
public class Challenge6Test {
    ...
    public void testTicketMovesThroughChainStrict() {
        ...
        assertTrue("El ticket debe llegar al tecnico avanzado", output.contains("Carlos - Advanced Technician"));
        assertTrue("El tecnico avanzado debe resolver el ticket", output.contains("Resolved by: Carlos - Advanced Technician"));
    }
    ...
    public void testMultipleTicketsStrict() {
        ...
        assertTrue("El tercer ticket debe ser resuelto por el tecnico avanzado", output.contains("Resolved by: Carlos - Advanced Technician"));
    }
    ...
    public void testSummaryStrict() {
        ...
        assertTrue("Falta el tecnico que resolvio el ticket", output.contains("Resolved by: Daniel - Basic Technician"));
    }
